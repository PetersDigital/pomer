...
void main() {
  group('StatisticsProvider', () {
    test('sessionsByDateRange correctly filters by Date, taskId, and tag',
        () async {
      ...
      await db.into(db.tasks).insert(TasksCompanion.insert(
          id: const Value(task1Id), title: 'T1', tag: const Value('Urgent'),),);
      await db.into(db.tasks).insert(TasksCompanion.insert(
          id: const Value(task2Id), title: 'T2', tag: const Value('Work'),),);
